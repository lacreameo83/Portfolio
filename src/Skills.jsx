...
function Skills() {
  ...
  return (
    <div className="p-6  sm:p-10   backdrop-blur-md  rounded-lg">
      {/* Section Header */}
      <div className="flex flex-col items-center text-center pb-6">
        <h2 className="text-3xl font-bold text-gray-800 mb-2">My Skills</h2>
        <p className="text-lg text-gray-600">Proficiency & Expertise</p>
      </div>
      ...
      >
        {skills.map((skill, index) => (
          <motion.div
            key={index}
            className="p-4 rounded-lg shadow-md hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 bg-white/50 backdrop-blur-lg"
