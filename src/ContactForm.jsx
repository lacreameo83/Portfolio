...
function ContactForm() {
  ...
  // Initialize EmailJS
  emailjs.init("7r9zS3cxaifIiWTaz"); // Replace with your EmailJS Public Key
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_84ojcbz", // Replace with your EmailJS Service ID
        "template_l441tvh", // Replace with your EmailJS Template ID
        {
      ...
      .then(
        ...
        (error) => {
          ...
          setError(
            error.text || "Failed to send the message. Please try again later."
          );
        }
      );
  };
  ...
  return (
    <div className="w-full bg-black border-t py-10">
